            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::number('precoVenda', $produto->precoVenda , ['class' => 'form-control','required'=>'required','step' => '0.01']) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label(__('Cor:')) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label(__('Peso:')) !!}
                        {!! Form::number('peso', $produto->peso , ['class' => 'form-control','required'=>'required','step' => '0.01']) !!}
                    </div>
                    <div class="form-group">
